...
interface Analytics {
  ...
  foodWasteReductionByMonth: Record<string, number>;
  foodWasteReductionPercentByMonth: Record<string, number>;
  ingredientsAddedByMonth: Record<string, number>;
  ingredientsUsedByMonth: Record<string, number>;
  ingredientsExpiredByMonth: Record<string, number>;
  totalIngredientsAdded: number;
  totalIngredientsUsed: number;
  totalIngredientsExpired: number;
  foodWasteReductionRate: number;
  topSavedIngredient: string;
...
if (!isAdmin) return null;
  ...
  value={data.foodWasteReductionRate || 0}
  icon="♻️"
  color="#2d6a4f"
/>
...
<StatCard
  ...
  value={data.totalIngredientsUsed || 0}
  icon="🍳"
  color="#2ecc71"
/>

<StatCard
  label="Ingredients Expired"
  value={data.totalIngredientsExpired || 0}
  icon="🗑️"
  color="#e74c3c"
/>
...
>
  ...
  <p style={{ color: "#555", fontSize: 14 }}>
    Most saved ingredient: <b>{data.topSavedIngredient}</b> · Most wasted
    ingredient: <b>{data.topWastedIngredient}</b>
  </p>
</div>
      </div>
      ...
      <BarChart
  data={data.foodWasteReductionByMonth}
  title="🌱 Food Waste Reduction: Ingredients Used per Month"
  />
  
  <BarChart
  data={data.foodWasteReductionPercentByMonth}
  title="♻️ Food Waste Reduction Progress (%)"
  />

  <BarChart
  data={data.ingredientsAddedByMonth}
  title="🥫 Ingredients Added per Month"
/>

<BarChart
  data={data.ingredientsUsedByMonth}
  title="🍳 Ingredients Used per Month"
/>

<BarChart
  data={data.ingredientsExpiredByMonth}
  title="🗑️ Ingredients Expired per Month"
/>
